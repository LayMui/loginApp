export const config = {
    ...
    commonCapabilities: {
      project: "Common Services e2e Test",
      "appium:newCommandTimeout": 500,
      autoAcceptAlerts: "true",
      autoDismissAlerts: "true",
      autoGrantPermissions: "true",
      name: "User Management Login",
    ...
    cucumberOpts: {
      ...
      tags: '@test',
      // <number> timeout for step definitisons
      timeout: 1000000,
    ...
    //  cucumberJson.attach(await browser.takeScreenshot(), 'reporter/screenshots');
    //  },
    /**
     *
     * Runs before a Cucumber Scenario.
